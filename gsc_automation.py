...
PROPERTY_URL = "sc-domain:knowleapstrategies.com"
...
def report_pages(service, days, limit):
    ...
    print("-" * 82)
    for i, row in enumerate(rows, 1):
        page = row["keys"][0].replace("https://knowleapstrategies.com", "")[:49] or "/"
...
def main():
    parser = argparse.ArgumentParser(description="GSC Automation - knowleapstrategies.com")
